...
/**
 * SchemaValidator - A flexible JSON schema validation library with advanced features
 */
class SchemaValidator {
  ...
  constructor(schemaPathOrFolderName = 'api-schemas', options = {}) {
    const {
      ...
      customFormats: additionalFormats = {},
      environment = null
    } = options;

    // Auto-detect Bruno environment
    const isBrunoEnv = environment === 'bruno' || (typeof bru !== 'undefined' && typeof bru.cwd === 'function');
